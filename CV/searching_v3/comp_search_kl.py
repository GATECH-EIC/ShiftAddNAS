...
path_cifar_ws = '../searching_v2/work_dirs/cifar100/Supernet_v2/arch_ranking_resume.pth.tar'
...
plt.tight_layout()
plt.savefig('./work_dirs/corr_v1_v2.pdf')
plt.savefig('./work_dirs/corr_v1_v2.svg')
