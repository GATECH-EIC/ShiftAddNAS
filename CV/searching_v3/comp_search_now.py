...
path_cifar_ws = '../searching_v3/work_dirs/cifar100/Supernet_v3/arch_ranking.pth.tar'
...
plt.tight_layout()
plt.savefig('./work_dirs/corr_v2_v3.pdf')
plt.savefig('./work_dirs/corr_v2_v3.svg')
