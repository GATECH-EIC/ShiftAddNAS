...
data_train_list = '/mnt/scratch/qiuling/ILSVRC/ImageSets/CLS-LOC/my_train.txt'
# data_train_root = '../data/imagenet/train'
data_train_root = '/mnt/scratch/qiuling/ILSVRC/Data/CLS-LOC/train'
...
data_test_list = '/mnt/scratch/qiuling/ILSVRC/ImageSets/CLS-LOC/my_val.txt'
# data_test_root = '../data/imagenet/val'
data_test_root = '/mnt/scratch/qiuling/ILSVRC/Data/CLS-LOC/val'
...
custom_hooks = [
    ...
    dict(
        ...
        workers_per_gpu=4,
        epoch_per_stage=6,
        resume_best_path='work_dirs/hytra_bs64_accumulate8_ep6_multi_aug_gpus8_full/path_rank/bestpath_3_5_08-04-12.yml')  # e.g. 'path_rank/bestpath_2.yml'
]
# resume_from = 'checkpoints/stage3_epoch3.pth'
# resume_from = 'work_dirs/hytra_bs64_accumulate8_ep6_multi_aug_gpus8_full/stage3_epoch2.pth'
resume_from = 'work_dirs/hytra_bs64_accumulate8_ep6_multi_aug_gpus8_full/ckpt.pth'
