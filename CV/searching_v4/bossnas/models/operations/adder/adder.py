...
import bossnas.models.operations.deepshift.ste as ste

from torch.utils.cpp_extension import load
adder_cuda = load(
  'adder_cuda', ['bossnas/models/operations/adder/adder_cuda.cpp', 'bossnas/models/operations/adder/adder_cuda_kernel.cu'], verbose=True)
...
class Adder2D_ws(nn.Module):
    ...
    def __init__(self,
                 ...
                 eta = 0.2,
                 quantize=False, weight_bits=8, sparsity=0, momentum=0.9, quantize_v='sbm'):
        super(Adder2D_ws, self).__init__()
        self.stride = stride
        self.padding = padding
        self.groups = groups
        self.kernel_size = kernel_size
        ...
        self.adder = self.shared_weight['weight'].reshape(self.shared_weight['weight_shape'])
