...
path_cifar_ws = '../searching_v4/work_dirs/cifar100/Supernet_v4/arch_ranking.pth.tar'
...
plt.tight_layout()
plt.savefig('./work_dirs/corr_v1_v4.pdf')
plt.savefig('./work_dirs/corr_v1_v4.svg')
