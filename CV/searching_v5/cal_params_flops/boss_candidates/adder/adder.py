...
import cal_params_flops.boss_candidates.deepshift.ste as ste

from torch.utils.cpp_extension import load
adder_cuda = load(
  'adder_cuda', ['cal_params_flops/boss_candidates/adder/adder_cuda.cpp', 'cal_params_flops/boss_candidates/adder/adder_cuda_kernel.cu'], verbose=True)
