...
from cal_params_flops.boss_candidates.resnet_op import ResConv, ResAdd, ResShift_Q
...
@register_model
def bossnet_T1_mix_v4_Q(pretrained=False, **kwargs):
    """Constructs a ResNet-26-D model.
    stem_width=32, stem_type='deep'
    """
    model = BossNet(encoding=[[1, 1], [1, 3, 1, 1], [3, 1, 0, 3, 3], [0, 0, 1, 0, 0]], avg_down=True, act_layer=SiLU, #act_layer=nn.SiLU,
                    attn_layer='se', last_stride=1)
    model.default_cfg = _cfg()
    return model
