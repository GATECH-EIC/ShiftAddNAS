...
from cal_params_flops.cal_flops import get_customized_model
...
class EvolutionSearch(object):
    ...
    def is_legal(self, cand):
        ...
        n_parameters, n_flops = get_customized_model(list(cand))
        ...
        info['flops'] = n_flops / 2 / 1e9 # MACs (G)
...
def get_args_parser():
    ...
    parser.add_argument('--param-limits', type=float, default=40) # M
    parser.add_argument('--min-param-limits', type=float, default=15) # M
    parser.add_argument('--flop-limits', type=float, default=8) # G
    parser.add_argument('--min-flop-limits', type=float, default=3) # G
