...
def get_parser(desc, default_task='translation'):
    ...
    parser.add_argument('--num_bits_grad', type=int, default=8)

    parser.add_argument('--num_cyclic_period', type=int, default=20)
    ...
    parser.add_argument('--print_precision', default=100, type=int,
                        help='evaluate model every (default: 100) iterations')

    parser.add_argument('--shift_ffn', action='store_true', help='whether to use shift as FFN layers')
