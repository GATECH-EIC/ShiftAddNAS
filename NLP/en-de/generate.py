...
def my_parser_config(config):
    ...
    config['encoder']['encoder_block_types'] = [[item] for item in config['encoder']['encoder_block_types']]
    return config
...
def cli_main():
    ...
    parser.add_argument('--encoder-block-types-all-subtransformer', nargs='+', default=None, type=str)
    parser.add_argument('--decoder-block-types-all-subtransformer', nargs='+', default=None, type=str)
