...
if __name__ == '__main__':
    ...
    #     "encoder_layers": 6,
    #     "encoder_num_head": [4, 4, 4, 8, 8, 4],
    #     # decoder
    #     "decoder_embedding_dim": 512,
    #     "decoder_ffn_dim": [2048, 2048, 3072, 3072],
    #     "decoder_layers": 4,
    #     "decoder_num_head_1": [4, 8, 8, 4],
    #     "decoder_num_head_2": [4, 8, 8, 8],
    #     # ende
    #     "arbitrary_ende": [-1, -1, 1, -1]
    # }

    # if os.path.exists('HAT_raspi_28.2_encoder.csv'):
    #     os.remove('HAT_raspi_28.2_encoder.csv')

    # if os.path.exists('HAT_raspi_28.2_decoder.csv'):
    #     os.remove('HAT_raspi_28.2_decoder.csv')

    # main_encoder(config, save_name='HAT_raspi_28.2_encoder.csv')
    # main_decoder(config, save_name='HAT_raspi_28.2_decoder.csv')
    ...
    #     "encoder_ffn_dim": [3072, 3072, 3072, 3072, 3072, 3072],
    #     "encoder_layers": 6,
    #     "encoder_num_head": [8, 4, 8, 8, 8, 8],
    #     # decoder
    #     "decoder_embedding_dim": 512,
    #     "decoder_ffn_dim": [2048, 2048, 3072, 3072, 2048],
    #     "decoder_layers": 5,
    #     "decoder_num_head_1": [8, 8, 8, 4, 8],
    #     "decoder_num_head_2": [4, 8, 8, 8, 8],
    #     # ende
    #     "arbitrary_ende": [-1, 1, 1, 1, -1]
    # }



    # if os.path.exists('HAT_raspi_28.4_encoder.csv'):
    #     os.remove('HAT_raspi_28.4_encoder.csv')

    # if os.path.exists('HAT_raspi_28.4_decoder.csv'):
    #     os.remove('HAT_raspi_28.4_decoder.csv')

    # main_encoder(config, save_name='HAT_raspi_28.4_encoder.csv')
    # main_decoder(config, save_name='HAT_raspi_28.4_decoder.csv')
    ...
    #     # encoder
    #     "encoder_embedding_dim": 512,
    #     "encoder_ffn_dim": [3072, 3072, 3072, 2048, 3072, 3072],
    #     "encoder_layers": 6,
    #     "encoder_num_head": [8, 8, 8, 8, 8, 4],
    #     # decoder
    #     "decoder_embedding_dim": 512,
    #     "decoder_ffn_dim": [1024, 2048, 3072],
    #     "decoder_layers": 3,
    #     "decoder_num_head_1": [4, 8, 8],
    #     "decoder_num_head_2": [4, 8, 8],
    #     # ende
    #     "arbitrary_ende": [-1, 1, -1]
    # }


    # if os.path.exists('HAT_raspi_27.8_encoder.csv'):
    #     os.remove('HAT_raspi_27.8_encoder.csv')

    # if os.path.exists('HAT_raspi_27.8_decoder.csv'):
    #     os.remove('HAT_raspi_27.8_decoder.csv')

    # main_encoder(config, save_name='HAT_raspi_27.8_encoder.csv')
    # main_decoder(config, save_name='HAT_raspi_27.8_decoder.csv')
    ...
    #     "encoder_ffn_dim": [3072, 3072, 3072, 3072, 3072, 3072],
    #     "encoder_layers": 6,
    #     "encoder_num_head": [4, 8, 8, 4, 8, 8],
    #     # decoder
    #     "decoder_embedding_dim": 512,
    #     "decoder_ffn_dim": [3072, 3072],
    #     "decoder_layers": 2,
    #     "decoder_num_head_1": [8, 8],
    #     "decoder_num_head_2": [8, 8],
    #     # ende
    #     "arbitrary_ende": [-1, 1]
    # }


    # if os.path.exists('HAT_raspi_27.6_encoder.csv'):
    #     os.remove('HAT_raspi_27.6_encoder.csv')

    # if os.path.exists('HAT_raspi_27.6_decoder.csv'):
    #     os.remove('HAT_raspi_27.6_decoder.csv')

    # main_encoder(config, save_name='HAT_raspi_27.6_encoder.csv')
    # main_decoder(config, save_name='HAT_raspi_27.6_decoder.csv')

    # HAT_raspi_26.9
    # config = {
    #     # encoder
    #     "encoder_embedding_dim": 512,
    #     "encoder_ffn_dim": [3072, 2048, 3072, 2048, 3072, 2048],
    #     "encoder_layers": 6,
    #     "encoder_num_head": [8, 8, 8, 4, 8, 8],
    #     # decoder
    #     "decoder_embedding_dim": 512,
    #     "decoder_ffn_dim": [1024, 2048],
    #     "decoder_layers": 2,
    #     "decoder_num_head_1": [4, 4],
    #     "decoder_num_head_2": [8, 8],
    #     # ende
    #     "arbitrary_ende": [-1, -1]
    # }
    ...
    # if os.path.exists('HAT_raspi_26.9_encoder.csv'):
    #     os.remove('HAT_raspi_26.9_encoder.csv')

    # if os.path.exists('HAT_raspi_26.9_decoder.csv'):
    #     os.remove('HAT_raspi_26.9_decoder.csv')

    # main_encoder(config, save_name='HAT_raspi_26.9_encoder.csv')
    # main_decoder(config, save_name='HAT_raspi_26.9_decoder.csv')
    ...
    config = {
        # encoder
        "encoder_embedding_dim": 512,
        "encoder_ffn_dim": [1024, 3072, 3072, 2048, 2048, 2048],
        "encoder_layers": 6,
        "encoder_num_head": [4, 8, 4, 4, 4, 8],
        # decoder
        "decoder_embedding_dim": 512,
    ...
    if os.path.exists('HAT_raspi_25.8_encoder.csv'):
        os.remove('HAT_raspi_25.8_encoder.csv')

    if os.path.exists('HAT_raspi_25.8_decoder.csv'):
        os.remove('HAT_raspi_25.8_decoder.csv')

    main_encoder(config, save_name='HAT_raspi_25.8_encoder.csv')
    main_decoder(config, save_name='HAT_raspi_25.8_decoder.csv')
