...
def get_unit_energy(layer_dict, block_type, num_bits=32):
    ...
    elif (layer_dict["type"] == "Shift_mlp"):
        unit_energy["unit_comp"] = unit_shift/(1e9) # mJ/MAC
    else:
        unit_energy["unit_comp"] = unit_mult/(1e9) # mJ/MAC
...
if __name__ == '__main__':
    ...
    if os.path.exists('350ms_encoder_32bits_all_shift.csv'):
        os.remove('350ms_encoder_32bits_all_shift.csv')

    if os.path.exists('350ms_decoder_32bits_all_shift.csv'):
        os.remove('350ms_decoder_32bits_all_shift.csv')

    main_encoder(config, save_name='350ms_encoder_32bits_all_shift.csv')
    main_decoder(config, save_name='350ms_decoder_32bits_all_shift.csv')
