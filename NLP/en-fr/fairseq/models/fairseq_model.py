...
class FairseqEncoderDecoderModel(BaseFairseqModel):
    ...
    def forward(self, num_bits, num_bits_grad, src_tokens, src_lengths, prev_output_tokens, **kwargs):
        """
        ...
        """
        encoder_out = self.encoder(src_tokens, src_lengths=src_lengths, num_bits=num_bits, num_bits_grad=num_bits_grad, **kwargs)
        decoder_out = self.decoder(prev_output_tokens, encoder_out=encoder_out, num_bits=num_bits, num_bits_grad=num_bits_grad, **kwargs)
        return decoder_out
