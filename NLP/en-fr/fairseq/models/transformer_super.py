...
class TransformerSuperModel(SuperFairseqEncoderDecoderModel):
    ...
    def add_args(parser):
        ...
        # dummy
        # types of blocks
        parser.add_argument('--block-types', nargs='+', default=[None])
    ...
    def build_model(cls, args, task):
        ...
        print('src_dict, tgt_dict: ', len(src_dict), len(tgt_dict))
...
class TransformerEncoder(FairseqEncoder):
    ...
    def forward(self, src_tokens, src_lengths, num_bits=-1, num_bits_grad=-1):
        ...
        # print('source tokens: ', src_tokens.shape)
        # print('source length: ', src_lengths)
