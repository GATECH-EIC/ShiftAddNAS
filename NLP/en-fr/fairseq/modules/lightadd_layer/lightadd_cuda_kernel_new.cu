...
#include "lightadd_cuda_forward.cu"
#include "lightadd_cuda_backward.cu"
...
__global__
void lightadd_forward_kernel(const scalar_t* input,
...
template<int FS, int SB, int padding_l, typename scalar_t>
__global__
void lightadd_grad_wrt_input_kernel(
...
template<int FS, int SB, int padding_l, typename scalar_t>
__global__
void lightadd_grad_wrt_weights_firstpass_short_kernel(
    const scalar_t* input,
...
__global__
void lightadd_grad_wrt_weights_secondpass_short_kernel(
    const float* input,
    const int minibatch,
...
template<int FS, int SB, int padding_l, typename scalar_t>
__global__
void lightadd_grad_wrt_weights_firstpass_kernel(
    const scalar_t* input,
    const scalar_t* gradInput,
    int minibatch,
    int sequenceLength,
...
template<int FS, int SB, typename scalar_t>
__global__
void lightadd_grad_wrt_weights_secondpass_kernel(
    const float* input,
    const int minibatch,
    const int numFiltersInBlock,
    scalar_t* output) {
