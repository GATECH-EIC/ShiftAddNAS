...
from fairseq import checkpoint_utils, distributed_utils, models, optim, utils, tokenizer
...
class Trainer(object):
    ...
    def train_step(self, samples, dummy_batch=False, raise_oom=False, configs=[None], num_bits=-1, num_bits_grad=-1):
    ...
    def valid_step(self, sample, raise_oom=False, num_bits=-1, num_bits_grad=-1):
