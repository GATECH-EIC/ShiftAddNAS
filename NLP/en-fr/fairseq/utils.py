...
def sample_configs(choices, reset_rand_seed, rand_seed=0, super_decoder_num_layer=6):
    ...
    for _ in range(config['encoder']['encoder_layer_num']):
        ...
        # new added
        encoder_block_types.append(random.choices(choices['encoder']['encoder_block_types']))
    ...
    # new added
    config['encoder']['encoder_block_types'] = encoder_block_types
    ...
    for _ in range(config['decoder']['decoder_layer_num']):
        ...
        # new added
        decoder_block_types.append(random.choice(choices['decoder']['decoder_block_types']))
    ...
    # new added
    config['decoder']['decoder_block_types'] = decoder_block_types
...
def get_subtransformer_config(args):
    ...
    config = {
        'encoder': {
            ...
            # new added
            'encoder_block_types': args.encoder_block_types_all_subtransformer,
        },
        'decoder': {
            ...
            # new added
            'decoder_block_types': args.decoder_block_types_all_subtransformer,
        }
    }
...
def get_all_choices(args):
    ...
    all_choices = {
        'encoder': {
            ...
            # new added
            # 'encoder_block_types': args.block_types,
            'encoder_block_types': args.encoder_block_types,
        ...
        'decoder': {
            ...
            # new added
            # 'decoder_block_types': args.block_types,
            'decoder_block_types': args.decoder_block_types,
        }
    }
...
def get_feature_info():
    return ['encoder_embed_dim', 'encoder_layer_num', 'encoder_ffn_embed_dim_avg', 'encoder_self_attention_heads_avg', \
            'decoder_embed_dim', 'decoder_layer_num', 'decoder_ffn_embed_dim_avg', 'decoder_self_attention_heads_avg', \
            'decoder_ende_attention_heads_avg', 'decoder_arbitrary_ende_attn_avg',
            'encoder_block_types', 'decoder_block_types']
...
def get_config_features(config):
    ...
    # new added
    encoder_types = config['encoder']['encoder_block_types'][:encoder_layer_num]
    str_encoder_types = ''
    for i in encoder_types:
        if isinstance(i, list):
            ...
            str_encoder_types += i
            str_encoder_types += '-->'
    decoder_types = config['decoder']['decoder_block_types'][:decoder_layer_num]
    str_decoder_types = ''
    for j in decoder_types:
        str_decoder_types += j
        str_decoder_types += '-->'
    # print('str_encoder_types', str_encoder_types)
    # print('str_decoder_types', str_decoder_types)
    features.append(str_encoder_types)
    features.append(str_decoder_types)
...
def get_represent_configs(args):
    ...
    largest_arbitrary1 = {
        'encoder': {
            ...
            # new added
            # 'encoder_block_types': [random.choices(args.block_types) for i in range(args.encoder_layers)],
            'encoder_block_types': [random.choices(args.encoder_block_types) for i in range(args.encoder_layers)],
        ...
        'decoder': {
            ...
            # new added
            # 'decoder_block_types': [random.choices(args.block_types) for i in range(args.decoder_layers)],
            'decoder_block_types': [random.choices(args.decoder_block_types) for i in range(args.decoder_layers)],
        }
    }
