...
if __name__ == '__main__':
    ...
    # if os.path.exists('350ms_encoder_32bits.csv'):
    #     os.remove('350ms_encoder_32bits.csv')

    # if os.path.exists('350ms_decoder_32bits.csv'):
    #     os.remove('350ms_decoder_32bits.csv')

    # main_encoder(config, save_name='350ms_encoder_32bits.csv')
    # main_decoder(config, save_name='350ms_decoder_32bits.csv')
    ...
    #     # encoder
    #     "encoder_embedding_dim": 512,
    #     "encoder_ffn_dim": [1024, 3072, 1024, 1024, 2048, 4096],
    #     "encoder_layers": 6,
    #     "encoder_num_head": [8, 8, 4, 8, 8, 8],
    #     "encoder_block_types": ["self_attention+lightweight_add", "self_attention+lightweight_conv",
    #         "self_attention", "self_attention+lightweight_conv", "self_attention+lightweight_shiftadd", "self_attention+lightweight_conv"],
    #     # decoder
    #     "decoder_embedding_dim": 512,
    #     "decoder_ffn_dim": [4096],
    #     # "decoder_ffn_dim": [2048, 2048, 3072, 3072],
    #     "decoder_layers": 1,
    #     "decoder_num_head_1": [8],
    #     "decoder_num_head_2": [4],
    #     "decoder_block_types": ["self_attention"],
    #     # ende
    #     "arbitrary_ende": [2]
    # }
    ...
    # if os.path.exists('120ms_Aug_14_encoder_32bits.csv'):
    #     os.remove('120ms_Aug_14_encoder_32bits.csv')

    # if os.path.exists('120ms_Aug_14_decoder_32bits.csv'):
    #     os.remove('120ms_Aug_14_decoder_32bits.csv')

    # main_encoder(config, save_name='120ms_Aug_14_encoder_32bits.csv')
    # main_decoder(config, save_name='120ms_Aug_14_decoder_32bits.csv')

    # # 150ms (update Aug. 14)
    # config = {
    #     # encoder
    #     "encoder_embedding_dim": 512,
    #     "encoder_ffn_dim": [2048, 1024, 3072, 1024, 1024, 4096],
    #     "encoder_layers": 6,
    #     "encoder_num_head": [4, 16, 8, 16, 8, 4],
    #     "encoder_block_types": ["self_attention+lightweight_conv", "self_attention",
    #         "self_attention+lightweight_conv", "self_attention+lightweight_conv", "self_attention", "self_attention"],
    #     # decoder
    #     "decoder_embedding_dim": 512,
    #     "decoder_ffn_dim": [4096, 4096],
    #     # "decoder_ffn_dim": [2048, 2048, 3072, 3072],
    #     "decoder_layers": 2,
    #     "decoder_num_head_1": [4, 16],
    #     "decoder_num_head_2": [4, 4],
    #     "decoder_block_types": ["self_attention+lightweight_conv", "self_attention"],
    #     # ende
    #     "arbitrary_ende": [2, 2]
    # }
    ...
    # if os.path.exists('150ms_Aug_14_encoder_32bits.csv'):
    #     os.remove('150ms_Aug_14_encoder_32bits.csv')

    # if os.path.exists('150ms_Aug_14_decoder_32bits.csv'):
    #     os.remove('150ms_Aug_14_decoder_32bits.csv')

    # main_encoder(config, save_name='150ms_Aug_14_encoder_32bits.csv')
    # main_decoder(config, save_name='150ms_Aug_14_decoder_32bits.csv')

    # 180ms (update Aug. 14)
    # config = {
    #     # encoder
    #     "encoder_embedding_dim": 512,
    #     "encoder_ffn_dim": [4096, 4096, 4096, 2048, 1024, 1024],
    #     "encoder_layers": 6,
    #     "encoder_num_head": [8, 8, 4, 4, 8, 8],
    #     "encoder_block_types": ["self_attention", "self_attention+lightweight_conv",
    #         "self_attention+lightweight_shiftadd", "self_attention", "self_attention", "self_attention"],
    #     # decoder
    #     "decoder_embedding_dim": 512,
    #     "decoder_ffn_dim": [4096, 4096],
    #     # "decoder_ffn_dim": [2048, 2048, 3072, 3072],
    ...
    # if os.path.exists('180ms_Aug_14_encoder_32bits.csv'):
    #     os.remove('180ms_Aug_14_encoder_32bits.csv')

    # if os.path.exists('180ms_Aug_14_decoder_32bits.csv'):
    #     os.remove('180ms_Aug_14_decoder_32bits.csv')

    # main_encoder(config, save_name='180ms_Aug_14_encoder_32bits.csv')
    # main_decoder(config, save_name='180ms_Aug_14_decoder_32bits.csv')

    # 350ms (update Aug. 14)
    # config = {
    #     # encoder
    #     "encoder_embedding_dim": 512,
    #     "encoder_ffn_dim": [3072, 2048, 4096, 2048, 4096, 4096],
    #     "encoder_layers": 6,
    #     "encoder_num_head": [16, 4, 4, 16, 4, 16],
    #     "encoder_block_types": ["self_attention+lightweight_add", "self_attention",
    #         "self_attention+lightweight_add", "self_attention+lightweight_add", "self_attention", "self_attention"],
    #     # decoder
    #     "decoder_embedding_dim": 512,
    #     "decoder_ffn_dim": [4096, 4096, 3072],
    #     # "decoder_ffn_dim": [2048, 2048, 3072, 3072],
    #     "decoder_layers": 3,
    #     "decoder_num_head_1": [4, 16, 8],
    #     "decoder_num_head_2": [4, 4, 4],
    #     "decoder_block_types": ["self_attention+lightweight_conv", "self_attention", "self_attention"],
    #     # ende
    #     "arbitrary_ende": [2, 2, 2]
    # }
    ...
    # if os.path.exists('350ms_Aug_14_encoder_32bits.csv'):
    #     os.remove('350ms_Aug_14_encoder_32bits.csv')

    # if os.path.exists('350ms_Aug_14_decoder_32bits.csv'):
    #     os.remove('350ms_Aug_14_decoder_32bits.csv')

    # main_encoder(config, save_name='350ms_Aug_14_encoder_32bits.csv')
    # main_decoder(config, save_name='350ms_Aug_14_decoder_32bits.csv')

    # 100ms (update Aug. 14)
    config = {
        # encoder
        "encoder_embedding_dim": 512,
        "encoder_ffn_dim": [1024, 1024, 1024, 4096, 3072, 4096],
        "encoder_layers": 6,
        "encoder_num_head": [8, 8, 16, 8, 4, 16],
        "encoder_block_types": ["self_attention+lightweight_add", "self_attention+lightweight_shiftadd",
            "self_attention", "self_attention+lightweight_add", "self_attention+lightweight_shiftadd", "self_attention"],
        # decoder
        "decoder_embedding_dim": 512,
        "decoder_ffn_dim": [4096],
        # "decoder_ffn_dim": [2048, 2048, 3072, 3072],
    ...
    if os.path.exists('100ms_Aug_14_encoder_32bits.csv'):
        os.remove('100ms_Aug_14_encoder_32bits.csv')

    if os.path.exists('100ms_Aug_14_decoder_32bits.csv'):
        os.remove('100ms_Aug_14_decoder_32bits.csv')

    main_encoder(config, save_name='100ms_Aug_14_encoder_32bits.csv')
    main_decoder(config, save_name='100ms_Aug_14_decoder_32bits.csv')