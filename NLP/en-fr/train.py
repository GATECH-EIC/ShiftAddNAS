...
def main(args, init_distributed=False):
    ...
    if args.profile_flops:
        ...
        macs = torchprofile.profile_macs(model.cuda(), args=(torch.tensor([dummy_src_tokens], dtype=torch.long).cuda(), torch.tensor([30]).cuda(), torch.tensor([dummy_prev], dtype=torch.long).cuda()))
    ...
    #     trainer.set_num_updates(17820)
    # print(lr, args.min_lr, epoch_itr.epoch, max_epoch, trainer.get_num_updates())
